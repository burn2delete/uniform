...
- Main branch baseline: `b7c88d0` (`Extend runtime-derived C control flow`).
...
- Public route completed and reviewed; runtime-derived scalar control flow is publicly selectable and fail-closed; next focus is semantic expansion followed by Gravity-authored compiler-stage replacement.
