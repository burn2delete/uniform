...
- Main branch baseline: `1b0ce25` (`Ignore quoted data during symbol resolution`).
...
- Public route completed and reviewed; runtime-derived scalar control flow is publicly selectable and fail-closed; quoted-data symbol analysis is corrected and the P15 compiler source now checks publicly; next focus is a bounded Gravity-authored stage2 compiler boundary.
