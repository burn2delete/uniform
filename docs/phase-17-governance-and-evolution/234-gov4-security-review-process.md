...
- AI tool and agent changes MUST include prompt-injection probes, tool authorization tests, `:ai/human-approval` policy, and eval gates.
...
- AI prompts, tools, model calls, memory, `:ai/human-approval`, evals, and generated actions.
...
- `A7`, `A8`, `A10`, and `A11` for AI memory, policy, `:ai/human-approval`, and prompt-injection defenses.
...
{:id "SEC-0001"
 ...
 :surfaces #{:ai-tool :capability :taint :ai/human-approval}
 :threat-model "prompt-injection-tool-escalation"
 :evidence [:negative-fixtures :redaction-tests :ai/human-approval-tests :eval-probes]
...
- AI review checks prompt-injection, tool authorization, `:ai/human-approval`, memory, eval, and generated action controls.
...
- AI prompt-injection, tool misuse, `:ai/human-approval`, and eval evidence.
...
- `GOV4006` when AI tool authority bypasses policy, `:ai/human-approval`, or eval gates.
