...
- [163 A10 - Human-in-the-Loop and Approval Workflow Specification](163-a10-human-in-the-loop-and-approval-workflow-specification.md)
...
AI is a first-class Gravity target, not an SDK side path. Model calls, tool calls, memory reads/writes, embeddings, `:ai/human-approval`, and generated code are effects with schemas, capabilities, policies, replay records, and evaluation evidence.
...
- Agent manifests bind models, prompts, tools, memory, policy, budgets, approval rules, and eval requirements.
