...
| 11 - AI and Agentic Programming | 11 | Verified | Read all 11 docs directly; replaced copied agent baselines with AI-specific contract shapes for programming model, providers, prompts, tools, agents, workflows, memory, policy, evals, approvals, and prompt-injection defenses, and fixed malformed workflow examples. |
...
| 13 - Tooling and Developer Experience | 13 | Verified | Read all 13 docs directly; replaced repeated stub tooling commands with concrete contracts for CLI, REPL, formatter, linter, LSP, debugger, docs, dev server, registry UX, IR inspector, profiler, safety audit explorer, and AI-assisted development workflows. |
...
| 16 - Standard Library | 20 | Verified | Replaced copied library stubs with profile-aware module APIs, effects, capabilities, artifacts, and rejection rules. |
