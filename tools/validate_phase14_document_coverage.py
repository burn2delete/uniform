#!/usr/bin/env python3
"""Validate Phase 14 document-specific conformance coverage."""
...
from gravity.conformance_document_coverage import validate_phase14_document_coverage_file  # noqa: E402


DEFAULT_ACCEPTED = ROOT / "docs/artifacts/phase-14/fixtures/document-coverage/accepted-conformance-document-coverage.json"
...
def main() -> int:
    ...
    try:
        artifact = validate_phase14_document_coverage_file(args.accepted)
        require(artifact["kind"] == "phase14-conformance-document-coverage-artifact", "artifact kind mismatch")
        ...
        print(f"Phase 14 document coverage validation failed: {exc}", file=sys.stderr)
        return 1
    ...
    print(
        "Phase 14 document coverage validation passed: "
