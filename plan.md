...
- [pending] Route the C target through a public compile boundary and replace constant-output lowering with a self-hosted/runtime-derived path.

## Baseline snapshot (2026-07-10)

- Main: `5fd0f4fdf9f2be7e8bc8a268f11269e1d42f3923`.
...
- Owner: `c_backend_slice`.
- Scope: source-derived C lowering/executable proof for the existing verified core instruction subset; JVM path preserved.
