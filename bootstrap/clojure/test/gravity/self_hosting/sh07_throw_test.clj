...
(def ^:private rejected-oracles
  {"throw-zero-arity"
   ...
   {:rule "C6-LOWERING-GAP"
    :reason :unsupported-list-core-form
    :facts {:operator 'try}
...
(deftest sh07-b7-accepted-pairs-use-v8-and-path-neutral-products
    ...
    (let [gravity (file-artifact "accepted" basename ".gravity")
      ...
      (testing basename
        ...
        (is (= :sh07-b7-meta-jvm-core
               ...
               (:scope (request qst))))
        (is (= "SH-07-B7" (:task gravity) (:task qst)))
        (is (= :c6-gravity-core-lowering-b7
  ...
  (doseq [basename accepted-basenames]
    (let [artifact (file-artifact "accepted" basename ".gravity")
      ...
      (testing basename
        ...
        (is (= :gravity/sh07-to-c6-core-products-v8
