...
(deftest thrown-gate-cleans-up-and-propagates
  (let [cleaned? (atom false)
        ...
        run-gate-var
        (ns-resolve 'gravity.self-hosting.sh01-development-test-runner
                    'run-gate)
        cleanup-var
        (ns-resolve 'gravity.self-hosting.sh01-development-test-runner
                    'cleanup!)]
...
(deftest foundation-compatibility-namespaces-are-static-and-selectable
  (let [parse-args @#'gravity.development-test-runner/parse-args
        selected-namespaces
        @#'gravity.development-test-runner/selected-namespace-records]
    (is (= ['gravity.bootstrap-compatibility.module-analysis-test
...
(deftest profile-capability-facade-catalog-is-exact-and-selectable
  (is (= [{:namespace 'gravity.bootstrap-compatibility.profile-validation-test
           :path "bootstrap/clojure/test/gravity/bootstrap_compatibility/profile_validation_test.clj"
           :selectors
           ["gravity.bootstrap-compatibility.profile-validation-test/profile-facades-match-head-4921fbc-reference-table"
            "gravity.bootstrap-compatibility.profile-validation-test/profile-head-reference-policy-denial-matrix-and-dynamic-seams"
          ...
          {:namespace 'gravity.bootstrap-compatibility.capability-validation-test
           ...
           ["gravity.bootstrap-compatibility.capability-validation-test/capability-facades-preserve-arglists-and-explicit-pass-parity"
            ...
            "gravity.bootstrap-compatibility.capability-validation-test/capability-captured-original-provider-interposition-is-one-shot"]}]
         (->> runner/namespace-catalog
              (filter #(contains? #{'gravity.bootstrap-compatibility.profile-validation-test
