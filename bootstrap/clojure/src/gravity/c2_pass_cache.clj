(ns gravity.c2-pass-cache
  ...
  This hosted Clojure leaf preserves the version-1 C2 semantic key and public
  result contract while adapting physical storage to generic pass-cache v2.
  Version-1 store bytes are forensic-only and never read or reinterpreted.  The
  leaf does not own C2 or C16 language authority, reader execution, artifact
  validation, release publication, proof, equivalence, or self-hosting.  Those
  decisions are injected by the bootstrap integration and rerun on every hit."
